...
input group "===   Inputs   ===";
input ulong Magic = 110;
input ENUM_TIMEFRAMES Timeframe = PERIOD_H1; //Change TF
...
double TriggerATR = 0;
input int len = 60; //Length
input double std = 1; //Standard Deviation
int Confirmation = -10;
...
void OnInit(){
   ...
   ATRHandler = iATR(_Symbol, PERIOD_D1, 100);
